...
#include<string.h>
 #include<stdio.h> 
struct quad { char op[5]; char arg1[10]; char arg2[10];
char result[10];
}QUAD[30];
...
{
       0,    21,    21,    23,    25,    26,    27,    29,    30,    31,
      32,    34,    36,    37,    39,    42,    43,    44,    45,    46,
      47,    48,    49,    51,    56,    58,    58,    66,    66,    74,
      77,    78,    80,    86,    86
};
#endif
...
#line 1254 "y.tab.c"
  ...
  case 25: /* $@1: %empty  */
#line 58 "bnf.y"
                           { strcpy(QUAD[Index].op,"=="); strcpy(QUAD[Index].arg1,(yyvsp[-1].var)); strcpy(QUAD[Index].arg2,"FALSE"); strcpy(QUAD[Index].result,"-1"); push(Index);
Index++;
}
#line 1262 "y.tab.c"
    break;
